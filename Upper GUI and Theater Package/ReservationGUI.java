...
public class ReservationGUI extends JPanel{
	...
	public ReservationGUI() {
		...
		JLabel lblNewLabel = new JLabel("Login Status: Not Logged In");
		lblNewLabel.setBounds(786, 17, 188, 25);
		...
		btnNewButton_1 = new JButton("Purchase Tickets");
		btnNewButton_1.setBounds(407, 489, 170, 40);
