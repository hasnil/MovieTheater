...
public class PurchaseTicketsGUI extends JPanel{
	...
	public PurchaseTicketsGUI() {
		...
		JLabel lblNewLabel_2 = new JLabel("Login Status: Not Logged In");
		lblNewLabel_2.setBounds(786, 25, 198, 23);
		...
		returnHomeButton.setBounds(20, 25, 116, 36);
		frame.add(returnHomeButton);
		
		JButton btnNewButton_2 = new JButton("Proceed to Make Payment");
		btnNewButton_2.setBounds(386, 434, 219, 45);
